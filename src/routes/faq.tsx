...
const items = [
  { q: "How long does shipping take?", a: "Local orders arrive in 2–5 business days. International orders 7–14 business days depending on customs." },
  ...
  { q: "How do I pay?", a: "After checkout you'll receive an Order ID and our bank account details. Transfer the exact amount using the Order ID as the reference, then upload your receipt via WhatsApp." },
  ...
  { q: "What if my size sells out?", a: "Contact us via WhatsApp — we may be able to restock or suggest a comparable pair." },
