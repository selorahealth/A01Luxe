...
const items = [
  { q: "How long does shipping take?", a: "Orders within Lagos arrive in 36-48 hours. While, orders outside Lagos take 7–14 business days depending on your location (or the destination/state)." },
  ...
  { q: "How do I track my order?", a: "Use the Track Order page and enter your Order ID (e.g. A01L-XXXXXX)." },
];
